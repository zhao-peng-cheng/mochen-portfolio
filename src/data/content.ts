...
export const profile = {
  ...
  contactMethods: [
    { icon: '/portfolio/icon-email.png', platform: 'QQ 邮箱', account: '1137104690@qq.com', action: '发邮件', actionType: 'qqmail' },
    { icon: '/portfolio/icon-wechat.png', platform: '微信', account: 'Zpc_101012510', action: '展开二维码', actionType: 'qrcode' },
    { icon: '/portfolio/icon-phone.png', platform: '联系电话', account: '18981682145', action: '复制', actionType: 'copy' },
    { icon: '/portfolio/icon-location.png', platform: '所在地', account: '广东 . 深圳', action: '复制', actionType: 'copy' },
  ],
  bio: [
...
export const projects: Project[] = [
  {
    ...
    accent: '#D4C5E8',
    image: '/portfolio/works/restored-portrait.png',
    size: 'wide',
    ...
    detailImages: [
      { src: '/portfolio/works/original-portrait.jpg', caption: '原图① — 褪色的复古人像老照片' },
      { src: '/portfolio/works/restored-portrait.png', caption: '成图① — AI 修复后的彩色人像' },
      { src: '/portfolio/works/original-group-photo.png', caption: '原图② — 黑白时代合影' },
      { src: '/portfolio/works/restored-group-photo.png', caption: '成图② — AI 上色修复后合影' },
      { src: '/portfolio/works/original-street-scene.png', caption: '原图③ — 民国时期街景' },
      { src: '/portfolio/works/restored-street-scene.png', caption: '成图③ — AI 修复后街景' },
      { src: '/portfolio/works/workflow-old-photo-restoration.png', caption: 'ComfyUI 完整工作流节点图' },
    ],
  },
  {
    id: '09',
    ...
    accent: '#C8DCE8',
    image: '/portfolio/works/interior-result-1.png',
    size: 'wide',
    ...
    detailImages: [
      { src: '/portfolio/works/interior-original-1.jpg', caption: '原图① — 原始室内空间照片' },
      { src: '/portfolio/works/interior-result-1.png', caption: '成图① — AI 生成的装潢效果图' },
      { src: '/portfolio/works/interior-original-2.jpg', caption: '原图② — 原始室内空间照片' },
      { src: '/portfolio/works/interior-result-2.png', caption: '成图② — AI 生成的装潢效果图' },
      { src: '/portfolio/works/interior-original-3.jpg', caption: '原图③ — 原始室内空间照片' },
      { src: '/portfolio/works/interior-result-3.png', caption: '成图③ — AI 生成的装潢效果图' },
      { src: '/portfolio/works/interior-workflow.png', caption: 'ComfyUI 完整工作流节点图' },
    ],
  },
  {
    id: '10',
    ...
    accent: '#E8D4C8',
    image: '/portfolio/works/portrait-result-1.jpg',
    size: 'wide',
    ...
    detailImages: [
      { src: '/portfolio/works/portrait-original-1.jpg', caption: '原图① — 人物原图' },
      { src: '/portfolio/works/portrait-necklace-1.jpg', caption: '珠宝参考① — 项链产品图' },
      { src: '/portfolio/works/portrait-result-1.jpg', caption: '成图① — AI 生成的珠宝人像大片' },
      { src: '/portfolio/works/portrait-original-2.jpg', caption: '原图② — 人物原图' },
      { src: '/portfolio/works/portrait-necklace-2.png', caption: '珠宝参考② — 项链产品图' },
      { src: '/portfolio/works/portrait-result-2.jpg', caption: '成图② — AI 生成的珠宝人像大片' },
      { src: '/portfolio/works/portrait-original-3.jpg', caption: '原图③ — 人物原图' },
      { src: '/portfolio/works/portrait-necklace-3.jpg', caption: '珠宝参考③ — 项链产品图' },
      { src: '/portfolio/works/portrait-result-3.jpg', caption: '成图③ — AI 生成的珠宝人像大片' },
      { src: '/portfolio/works/portrait-workflow.png', caption: 'ComfyUI 完整工作流节点图' },
    ],
  },
  {
    id: '11',
    ...
    accent: '#C8E8DC',
    image: '/portfolio/works/perspective-cover.png',
    size: 'wide',
    ...
    detailImages: [
      { src: '/portfolio/works/perspective-group-1.jpg', caption: '组图① — 视角转换效果展示' },
      { src: '/portfolio/works/perspective-group-2.jpg', caption: '组图② — 视角转换效果展示' },
      { src: '/portfolio/works/perspective-group-3.jpg', caption: '组图③ — 视角转换效果展示' },
      { src: '/portfolio/works/perspective-workflow.png', caption: 'ComfyUI 完整工作流节点图' },
    ],
  },
  {
    id: '12',
    ...
    accent: '#D4C5E8',
    image: '/portfolio/works/graphic-3.png',
    size: 'wide',
    ...
    detailImages: [
      { src: '/portfolio/works/graphic-3.png', caption: '作品① — 平面设计' },
      { src: '/portfolio/works/graphic-4.png', caption: '作品② — 平面设计' },
      { src: '/portfolio/works/graphic-6.png', caption: '作品③ — 平面设计' },
      { src: '/portfolio/works/graphic-7.png', caption: '作品④ — 平面设计' },
      { src: '/portfolio/works/graphic-8.png', caption: '作品⑤ — 平面设计' },
      { src: '/portfolio/works/graphic-9.png', caption: '作品⑥ — 平面设计' },
      { src: '/portfolio/works/graphic-10.png', caption: '作品⑦ — 平面设计' },
      { src: '/portfolio/works/graphic-11.png', caption: '作品⑧ — 平面设计' },
    ],
  },
  {
    id: '13',
    ...
    accent: '#E8D4C8',
    image: '/portfolio/works/style-transfer-result-1.png',
    size: 'wide',
    ...
    detailImages: [
      { src: '/portfolio/works/style-transfer-original-1.jpg', caption: '原图① — 原始照片' },
      { src: '/portfolio/works/style-transfer-result-1.png', caption: '成图① — 风格转绘效果' },
      { src: '/portfolio/works/style-transfer-original-2.png', caption: '原图② — 原始照片' },
      { src: '/portfolio/works/style-transfer-result-2.png', caption: '成图② — 风格转绘效果' },
      { src: '/portfolio/works/style-transfer-original-3.png', caption: '原图③ — 原始照片' },
      { src: '/portfolio/works/style-transfer-result-3.png', caption: '成图③ — 风格转绘效果' },
      { src: '/portfolio/works/style-transfer-original-4.png', caption: '原图④ — 原始照片' },
      { src: '/portfolio/works/style-transfer-result-4.png', caption: '成图④ — 风格转绘效果' },
    ],
  },
  {
    id: '25',
    ...
    accent: '#A8C4E6',
    image: '/portfolio/works/ip-poster.jpg',
    size: 'wide',
    ...
    detailPoster: '/portfolio/works/ip-detail-poster.jpg',
    ...
    sections: [
      {
        ...
        compact: true,
        images: [
          { src: '/portfolio/works/ip-detail-poster.jpg', caption: 'IP 主海报 — Cloudy Bobo · 温暖陪伴，治愈每一天' },
        ],
      },
      {
        ...
        images: [
          { src: '/portfolio/works/ip-basic-file.png', label: '01 / IP基础档案', caption: '基础档案 — 角色名 / 生日 / 性格 / 身型 / 角色定位 / 性格标签 / 三视参考' },
          { src: '/portfolio/works/ip-worldview.png', label: '02 / IP世界观', caption: '世界观故事背景 — 云梦纪时代设定 / 关键概念 / 核心冲突 / 使命 / 主要角色 / 场景 / 故事主线' },
          { src: '/portfolio/works/ip-three-view.png', label: '03 / IP人物三视图', caption: '人物三视图 — 正面 / 侧面 / 背面 + 头部细节 + 服饰细节 + 动态 + 比例 + 色彩 + 材质' },
          { src: '/portfolio/works/ip-color-card.png', label: '04 / IP标准色卡', caption: '标准色卡 — 主色调（云雾蓝 / 星雾蓝 / 云朵白 / 暖米白 / 雾霭蓝）+ 辅助色 + 情绪色 + 比例建议' },
          { src: '/portfolio/works/ip-details-showcase.png', label: '05 / IP细节展示', caption: '细节展示图 — 服饰纹理 / 材质结构 / 饰品工艺 / 特有符号 / 质感表现' },
          { src: '/portfolio/works/ip-design-keywords.png', label: '06 / IP设计关键词', caption: '设计关键词 — 造型关键词 / 风格关键词 / 细节关键词 / 场景关键词 / 关键词总结' },
          { src: '/portfolio/works/ip-expression-pack.png', label: '07 / IP表情包', caption: '表情包延伸专区 — 基础表情 + 动作表情 + 更多情绪 + 场景系列 + 延展建议' },
          { src: '/portfolio/works/ip-action-poses.png', label: '08 / IP动作', caption: '动作延伸专区 — 标志性 Pose + 可延展动作（跑 / 跳 / 蹲 / 飞）+ 更多延展' },
          { src: '/portfolio/works/ip-clothing-extensions.png', label: '09 / IP服装', caption: '服装延伸专区 — 现有穿着 + 日常 / 礼服 / 战斗 / 睡衣 / 季节限定 + 配饰细节 + 面料参考' },
          { src: '/portfolio/works/ip-merch-display.png', label: '10 / IP衍生周边', caption: '衍生周边展示专区 — 软周边 / 硬周边 / 联名盲盒 / 联名文具 + 更多衍生可能' },
        ],
      },
    ],
  },
  {
    ...
    accent: '#9CC4FF',
    image: '/portfolio/works/babysir-banner.png',
    size: 'wide',
    ...
    sections: [
      {
        ...
        compact: true,
        images: [
          { src: '/portfolio/works/babysir-main.png', caption: '产品主图 — 智能平衡辅助的体感与姿态呈现' },
        ],
      },
      {
        en: 'PRODUCT POSTER',
        ...
        compact: true,
        images: [
          { src: '/portfolio/works/babysir-poster.png', caption: '产品宣传海报 — 科技酷炫 · 智能防摔 · 童趣护具三大卖点强主推' },
        ],
      },
      {
        en: 'STORE BANNER',
        ...
        images: [
          { src: '/portfolio/works/babysir-banner.png', caption: '店铺焦点 Banner — 限时直降 100 / 到手价 ¥499' },
        ],
      },
      {
        en: 'DETAIL PAGE',
        ...
        images: [
          { src: '/portfolio/works/babysir-detail-1.png', caption: '详情 ① — 价值主张与情感共鸣' },
          { src: '/portfolio/works/babysir-detail-3.jpg', caption: '详情 ② — 用户痛点与产品解决方案' },
          { src: '/portfolio/works/babysir-detail-4.png', caption: '详情 ③ — 智能平衡辅助系统' },
          { src: '/portfolio/works/babysir-detail-5.jpg', caption: '详情 ④ — 稳定车身设计与多场景骑行' },
          { src: '/portfolio/works/babysir-detail-6.jpg', caption: '详情 ⑤ — 夜间氛围灯光与高亮 LED' },
          { src: '/portfolio/works/babysir-detail-7.jpg', caption: '详情 ⑥ — 防滑脚踏设计细节' },
        ],
      },
    ],
  },
  {
    ...
    tags: ['电商设计', 'AI 海报', '详情页', 'Banner'],
    accent: '#B564D9',
    image: '/portfolio/works/pigeon-banner.png',
    size: 'wide',
    ...
    sections: [
      {
        ...
        compact: true,
        images: [
          { src: '/portfolio/works/pigeon-main.png', caption: '产品主图 — 轻盈骑行 · 探索无限可能' },
        ],
      },
      {
        en: 'PRODUCT POSTER',
        ...
        compact: true,
        images: [
          { src: '/portfolio/works/pigeon-poster.png', caption: '产品宣传海报 — 6-12 岁户外越野山地车 / 双重碟刹 / 高亮大灯 / 买即送护具五件套' },
        ],
      },
      {
        en: 'STORE BANNER',
        ...
        images: [
          { src: '/portfolio/works/pigeon-banner.png', caption: '店铺焦点 Banner — 限时抢购 / 前 100 名送护具大礼包 / 到手价 ¥289 起' },
        ],
      },
      {
        en: 'DETAIL PAGE',
        ...
        images: [
          { src: '/portfolio/works/pigeon-detail-1.png', caption: '详情 ① — 价值主张（轻盈骑行）与四大核心卖点' },
          { src: '/portfolio/works/pigeon-detail-2.png', caption: '详情 ② — 功能亮点拆解（双重碟刹 / 轻量钢架 / 加宽越野胎 / 高亮大灯）' },
          { src: '/portfolio/works/pigeon-detail-3.png', caption: '详情 ③ — 产品参数与两色可选（粉紫渐变 / 星空蓝）' },
          { src: '/portfolio/works/pigeon-detail-4.png', caption: '详情 ④ — 细节品质（灵敏碟刹 / 时尚烤漆 / 轻松操控 / 高亮大灯）' },
          { src: '/portfolio/works/pigeon-detail-5.png', caption: '详情 ⑤ — 十万+ 真实评价与权威认证（3C / 质检 / 品牌直营）' },
          { src: '/portfolio/works/pigeon-detail-6.png', caption: '详情 ⑥ — 放心购买与搭配推荐（头盔 / 收纳挂架 / 水壶）' },
        ],
      },
    ],
  },
  {
    ...
    tags: ['电商设计', 'AI 海报', '详情页', 'Banner'],
    accent: '#D8A657',
    image: '/portfolio/works/sodiok-banner.jpg',
    size: 'wide',
    ...
    sections: [
      {
        ...
        compact: true,
        images: [
          { src: '/portfolio/works/sodiok-main.png', caption: '产品主图 — 高速稳定 · 金属质感随身存储' },
        ],
      },
      {
        en: 'PRODUCT POSTER',
        ...
        compact: true,
        images: [
          { src: '/portfolio/works/sodiok-poster.png', caption: '产品宣传海报 — 高速金属 U 盘 / 一体旋转机身 / ¥59.9 限时特惠' },
        ],
      },
      {
        en: 'STORE BANNER',
        ...
        images: [
          { src: '/portfolio/works/sodiok-banner.jpg', caption: '店铺焦点 Banner — 限时特惠 / 高速金属 U 盘 / 到手价 ¥59.9' },
        ],
      },
      {
        en: 'DETAIL PAGE',
        ...
        sub: 'Detail page — 六屏长图，从情感共鸣到功能拆解，解决购买顾虑',
        images: [
          { src: '/portfolio/works/sodiok-detail-1.png', caption: '详情 ① — 价值主张（高速稳定存储）与四大核心卖点' },
          { src: '/portfolio/works/sodiok-detail-2.png', caption: '详情 ② — 功能拆解（全合金磨砂 / 360° 旋转翻盖 / 一体挂链 / 迷你轻薄）' },
          { src: '/portfolio/works/sodiok-detail-3.png', caption: '详情 ③ — 传输性能（USB3.0 / 150MB·s / 5 倍速）' },
          { src: '/portfolio/works/sodiok-detail-4.png', caption: '详情 ④ — 多系统兼容（Windows / macOS / 安卓 / 车载 / 台式）' },
          { src: '/portfolio/works/sodiok-detail-5.png', caption: '详情 ⑤ — 多场景随身（办公 / 居家学习 / 车载 / 户外）' },
          { src: '/portfolio/works/sodiok-detail-6.png', caption: '详情 ⑥ — 产品参数与全面了解' },
        ],
      },
    ],
  },
  {
    ...
    accent: '#B564D9',
    image: '/portfolio/works/pigeon-tvc-cover.jpg',
    size: 'wide',
    blurb: '飞鸽（PIGEON）儿童自行车 TVC 商业广告——30 秒品牌宣传片《好搭档，就该能闯能停》，从故事板 → 实拍分镜 → 后期合成，构建电影感童车品牌片。',
    group: 'tvc',
    detailVideo: '/portfolio/works/pigeon-tvc.mp4',
    videoPoster: '/portfolio/works/pigeon-video-poster.png',
    ...
    sections: [
      {
        ...
        images: [
          { src: '/portfolio/works/pigeon-storyboard.png', caption: '完整故事板 — 角色风格参考 / 场景与机位设计 / 光线氛围 / 音频设计 / 摄影制作笔记' },
        ],
      },
    ],
  },
  {
    ...
    accent: '#9CC4FF',
    image: '/portfolio/works/babysir-tvc-cover.jpg',
    size: 'wide',
    blurb: 'Babysir 儿童平衡车 30 秒 TVC 商业广告《守护每一位自由勇敢的成长时光》——以 8 个分镜的镜头语言，从童年孤独 → 母亲期盼 → 与平衡车的相遇相知，呈现电影感治愈亲子片。',
    group: 'tvc',
    detailVideo: '/portfolio/works/babysir-tvc.mp4',
    videoPoster: '/portfolio/works/babysir-video-poster.jpg',
    ...
    sections: [
      {
        ...
        images: [
          { src: '/portfolio/works/babysir-storyboard.png', caption: '完整故事板 — 8 个分镜 / 风格参考 / 场景与机位 / 8 种镜头运动 / 情绪关键词 / 音频设计 / 摄影制作笔记' },
        ],
      },
    ],
  },
  {
    ...
    accent: '#D8A657',
    image: '/portfolio/works/sodiok-tvc-cover.png',
    size: 'wide',
    blurb: 'Sodiok 沙迪克金属 U 盘 TVC 商业广告——以「高速传输 · 金属质感 · 一体旋转」为核心卖点，构建数码科技感品牌宣传片。',
    group: 'tvc',
    detailVideo: '/portfolio/works/sodiok-tvc.mp4',
    videoPoster: '/portfolio/works/sodiok-tvc-poster.png',
    ...
    sections: [
      {
        ...
        images: [
          { src: '/portfolio/works/sodiok-storyboard.png', caption: '完整故事板 — 产品多角度特写 / 数据传输可视化 / 办公·车载·多场景应用 / 镜头运动 / 光线氛围 / 音频设计' },
        ],
      },
    ],
  },
  {
    ...
    accent: '#F2A93B',
    image: '/portfolio/works/charger-cover.png',
    size: 'wide',
    blurb: '充电宝电商信息流短视频——以「轻巧便携 · 超大容量 · 快充不发烫」为核心卖点，打造适合抖音/小红书信息流的强种草短视频，3 秒抓注意力、15 秒讲清价值。',
    group: 'feed',
    detailVideo: '/portfolio/works/charger-video.mp4',
  ...
  },
  {
    ...
    tags: ['电商信息流', '短视频', '信息流广告', '居家种草'],
    accent: '#7C6FD4',
    image: '/portfolio/works/bathtub-cover.png',
    size: 'wide',
    blurb: '泡澡桶电商信息流短视频——以「折叠省空间 · 恒温保暖 · 加厚耐用 · 全家适用」为核心卖点，打造适合抖音/小红书信息流的强种草短视频，3 秒抓注意力、15 秒讲清价值。',
    group: 'feed',
    detailVideo: '/portfolio/works/bathtub-video.mp4',
    detailSub: 'Concept — 信息流短视频 / 3 秒钩子 + 痛点共鸣 + 卖点快切 + 行动召唤 / 适配抖音·小红书·视频号',
  ...
  },
  {
    ...
    accent: '#9CC4E8',
    image: '/portfolio/works/bm-poster.jpg',
    size: 'wide',
    ...
    detailPoster: '/portfolio/works/bm-detail-poster.jpg',
    ...
    sections: [
      {
        ...
        compact: true,
        images: [
          { src: '/portfolio/works/bm-detail-poster.jpg', caption: 'IP 主海报 — Bing Miao Xi · 冰原温柔，喵汐相伴' },
        ],
      },
      {
        en: 'IP CHARACTER DESIGN',
        ...
        sub: '基础档案 / 世界观 / 人物三视图 / 标准色卡 / 细节展示 / 设计关键词 / 表情包 / 动作 / 服装 / 衍生周边',
        images: [
          { src: '/portfolio/works/bm-01-basic.jpg', label: '01 / IP基础档案', caption: '基础档案 — 角色定位 / 三视图 / 性格标签 / 技能设定 / 外观特征 / 可延展设定' },
          { src: '/portfolio/works/bm-02-worldview.jpg', label: '02 / IP世界观', caption: '世界观故事背景 — 时代设定 / 核心冲突 / 核心使命 / 故事线 / 象征元素 / 世界关键词' },
          { src: '/portfolio/works/bm-03-three-view.jpg', label: '03 / IP人物三视图', caption: '人物三视图专区 — 正面 / 侧面 / 背面 + 基础档案 + Q 版二头身比例' },
          { src: '/portfolio/works/bm-04-color-card.jpg', label: '04 / IP标准色卡', caption: '标准色卡 — 主色调（冰晶蓝 / 雾霜白 / 薄霜青 / 雾灰蓝 / 深海蓝）+ 辅助色 + 情绪色 + 渐变色搭配' },
          { src: '/portfolio/works/bm-05-details.jpg', label: '05 / IP细节展示', caption: '细节展示 — 服饰纹理 / 特有符号 / 质感表现 / 细节放大展示' },
          { src: '/portfolio/works/bm-06-keywords.jpg', label: '06 / IP设计关键词', caption: '设计关键词 — 造型关键词 / 风格关键词 / 色彩关键词 / 细节关键词 / 气质关键词' },
          { src: '/portfolio/works/bm-07-expression.jpg', label: '07 / IP表情包', caption: '表情包延伸专区 — 基础表情 + 动作表情结合（开心笑 / 委屈哭 / 惊讶 / 无语汗颜 / 开心转圈圈 / 委屈对手指等）' },
          { src: '/portfolio/works/bm-08-actions.jpg', label: '08 / IP动作', caption: '动作延伸专区 — 标志性 Pose + 可延展动作（跑 / 跳 / 蹲坐 / 飞行）+ 动作延展小贴士' },
          { src: '/portfolio/works/bm-09-clothing.jpg', label: '09 / IP服装', caption: '服装延伸专区 — 现有穿着 + 日常套装 / 礼服 / 战斗 / 睡衣 / 节日限定 + 配饰延伸 + 面料图案' },
          { src: '/portfolio/works/bm-10-merch.jpg', label: '10 / IP衍生周边', caption: '衍生周边展示专区 — 软周边（毛绒公仔 / 抱枕 / 钥匙扣）/ 硬周边（手办 / 徽章 / 手机壳）/ 联名向（盲盒 / 文具 / 礼盒）/ 更多延伸' },
        ],
      },
    ],
  },
